...
const ZONE_CONFIG = {
  etang: {
    ...
    problems: [
      { id: 'envase',    img: 'assets/img/problemes/prob-envase.jpg',     label: 'Manque de profondeur / envasement',       desc: 'Le fond remonte, l\'eau est peu profonde' },
      { id: 'vegetation',img: 'assets/img/problemes/prob-vegetation.jfif', label: 'Plantes aquatiques envahissantes',          desc: 'Nénuphars, herbiers, algues en surface' },
      { id: 'roseaux',   img: 'assets/img/problemes/prob-roseaux.jfif',    label: 'Roseaux qui colonisent les berges',        desc: 'Phragmites ou massettes qui s\'étendent' },
      { id: 'berges',    img: 'assets/img/problemes/prob-berges.jfif',     label: 'Berges qui s\'effondrent ou s\'érodent',    desc: 'Affaissements, éboulements de talus' },
      { id: 'boisement', img: 'assets/img/problemes/prob-boisement.jfif',  label: 'Végétation ligneuse envahissante',          desc: 'Arbres/arbustes qui empiètent sur les berges' },
      { id: 'inconnu',   img: 'assets/img/problemes/prob-diagnostic.jpg', label: 'Je ne sais pas — besoin d\'un expert',     desc: 'Diagnostic gratuit sur place' },
    ],
  },
  'etangs-multiples': {
    ...
    problems: [
      { id: 'envase',    img: 'assets/img/problemes/prob-envase.jpg',     label: 'Manque de profondeur / envasement',       desc: 'Un ou plusieurs bassins ensablés' },
      { id: 'vegetation',img: 'assets/img/problemes/prob-vegetation.jfif', label: 'Plantes aquatiques envahissantes',          desc: 'Nénuphars, herbiers, algues' },
      { id: 'roseaux',   img: 'assets/img/problemes/prob-roseaux.jfif',    label: 'Roseaux sur les berges',                   desc: 'Colonisation des bords' },
      { id: 'berges',    img: 'assets/img/problemes/prob-berges.jfif',     label: 'Berges dégradées',                         desc: 'Effondrements, érosion des talus' },
      { id: 'boisement', img: 'assets/img/problemes/prob-boisement.jfif',  label: 'Végétation ligneuse',                       desc: 'Arbres/arbustes à débroussailler' },
      { id: 'inconnu',   img: 'assets/img/problemes/prob-diagnostic.jpg', label: 'Besoin d\'un diagnostic global',           desc: 'Visite technique gratuite' },
    ],
  },
  riviere: {
    ...
    problems: [
      { id: 'envase',    img: 'assets/img/problemes/prob-envase.jpg',     label: 'Lit encombré / envasé',                    desc: 'Accumulation de vase, manque de débit' },
      { id: 'vegetation',img: 'assets/img/problemes/prob-vegetation.jfif', label: 'Végétation aquatique dense',                desc: 'Plantes qui freinent l\'écoulement' },
      { id: 'roseaux',   img: 'assets/img/problemes/prob-roseaux.jfif',    label: 'Roseaux sur les berges',                   desc: 'Colonisation des rives' },
      { id: 'berges',    img: 'assets/img/problemes/prob-berges.jfif',     label: 'Berges qui s\'érodent',                    desc: 'Affouillement, éboulements de rive' },
      { id: 'boisement', img: 'assets/img/problemes/prob-boisement.jfif',  label: 'Embâcles / végétation ligneuse',           desc: 'Arbres tombés, branches obstruant le lit' },
      { id: 'inconnu',   img: 'assets/img/problemes/prob-diagnostic.jpg', label: 'Besoin d\'un diagnostic',                  desc: 'Visite technique gratuite' },
    ],
  },
  fosse: {
    ...
    problems: [
      { id: 'envase',    img: 'assets/img/problemes/prob-envase.jpg',     label: 'Fossé colmaté / envasé',                   desc: 'Mauvaise évacuation des eaux' },
      { id: 'vegetation',img: 'assets/img/problemes/prob-vegetation.jfif', label: 'Végétation qui obstrue',                    desc: 'Herbes, lentilles d\'eau, algues' },
      { id: 'roseaux',   img: 'assets/img/problemes/prob-roseaux.jfif',    label: 'Roseaux envahissants',                     desc: 'Colonisation des berges du fossé' },
      { id: 'berges',    img: 'assets/img/problemes/prob-berges.jfif',     label: 'Talus abîmés',                             desc: 'Berges affaissées ou érodées' },
      { id: 'boisement', img: 'assets/img/problemes/prob-boisement.jfif',  label: 'Végétation ligneuse sur les bords',        desc: 'Broussailles, arbres à abattre' },
      { id: 'inconnu',   img: 'assets/img/problemes/prob-diagnostic.jpg', label: 'Besoin d\'un diagnostic',                  desc: 'Visite technique gratuite' },
    ],
  },
  marais: {
    ...
    problems: [
      { id: 'roseaux',   img: 'assets/img/problemes/prob-roseaux.jfif',    label: 'Roseaux / roselières trop denses',         desc: 'Extension incontrôlée des phragmites' },
      { id: 'boisement', img: 'assets/img/problemes/prob-boisement.jfif',  label: 'Lignification de la zone humide',           desc: 'Arbres/arbustes qui colonisent le marais' },
      { id: 'vegetation',img: 'assets/img/problemes/prob-vegetation.jfif', label: 'Plantes envahissantes (jussie, etc.)',       desc: 'Espèces invasives à contrôler' },
      { id: 'envase',    img: 'assets/img/problemes/prob-envase.jpg',     label: 'Atterrissement / envasement',              desc: 'Perte de surface en eau' },
      { id: 'berges',    img: 'assets/img/problemes/prob-berges.jfif',     label: 'Berges dégradées',                         desc: 'Effondrements de talus' },
      { id: 'inconnu',   img: 'assets/img/problemes/prob-diagnostic.jpg', label: 'Besoin d\'un diagnostic',                  desc: 'Visite technique gratuite' },
    ],
  },
  boisement: {
    ...
    problems: [
      { id: 'boisement', img: 'assets/img/problemes/prob-boisement.jfif',  label: 'Débroussaillage / broyage forestier',      desc: 'Végétation ligneuse à abattre et broyer' },
      { id: 'roseaux',   img: 'assets/img/problemes/prob-roseaux.jfif',    label: 'Roseaux ou fougères envahissants',         desc: 'Végétation basse dense' },
      { id: 'berges',    img: 'assets/img/problemes/prob-berges.jfif',     label: 'Berges boisées à sécuriser',               desc: 'Talus à renforcer ou à stabiliser' },
      { id: 'inconnu',   img: 'assets/img/problemes/prob-diagnostic.jpg', label: 'Besoin d\'un diagnostic / devis',          desc: 'Visite technique gratuite' },
    ],
  },
  autre: {
    ...
    problems: [
      { id: 'envase',    img: 'assets/img/problemes/prob-envase.jpg',     label: 'Envasement / accumulation de vase',       desc: 'Fond qui remonte, eau peu profonde' },
      { id: 'vegetation',img: 'assets/img/problemes/prob-vegetation.jfif', label: 'Végétation aquatique envahissante',         desc: 'Plantes qui couvrent la surface' },
      { id: 'roseaux',   img: 'assets/img/problemes/prob-roseaux.jfif',    label: 'Roseaux / végétation dense',               desc: 'Colonisation des berges' },
      { id: 'berges',    img: 'assets/img/problemes/prob-berges.jfif',     label: 'Berges dégradées',                         desc: 'Effondrements, érosion' },
      { id: 'boisement', img: 'assets/img/problemes/prob-boisement.jfif',  label: 'Végétation ligneuse',                       desc: 'Arbres/arbustes à gérer' },
      { id: 'inconnu',   img: 'assets/img/problemes/prob-diagnostic.jpg', label: 'Autre / besoin d\'un expert',              desc: 'Diagnostic gratuit sur place' },
    ],
  },
};
